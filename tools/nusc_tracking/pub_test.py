...
def parse_args():
    ...
    parser.add_argument("--work_dir", type=str, default="trackerData",help="the dir to save logs and tracking results")
    parser.add_argument(
        "--checkpoint", type=str, default="trackerData/detection.json",help="the dir to checkpoint which the model read from"
    )
    parser.add_argument("--hungarian", action='store_true')
    parser.add_argument("--root", type=str, default="/mnt/centerpoints/data/test/v1.0-test_blobs")
